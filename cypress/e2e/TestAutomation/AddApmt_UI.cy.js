...
describe('Add appointment through UI', () => {
  it('Add Apmnt thru UI', () => {
    var start_date="";
    var end_date= "";
   ...
   //visit my container watchlist screen
    ...
    //click on the container in the most recent of the list
     ...
     cy.wait(2000)
  //click on top container edit service screen
 // cy.xpath("//span[contains(text(),'JUAN9999990')]").click()
 // cy.get(':nth-child(3) > .layout-row.flex > :nth-child(1) > .layout-xs-column > .layout-column.flex-xl-5 > .md-menu-height > .md-icon-button').click()
    ...
    // cy.get('#input_29').clear()
    // cy.get('.md-dialog-content > .layout-row > .md-button').click({force: true})
    // cy.get('#input_29').type(end_time).click()
    //Select the trucker company or assign later
     cy.get('#select_6').click()
     cy.get('#select_option_23').click({force: true})  
    ...
    //verify the appointment status and date/time
     ...
     cy.get(':nth-child(4) > .pro-lbl-text-16').contains('09:00')
    ...
    //click on submit button 
    cy.get('.emPro-border-top > .layout-row > .md-raised').should('be.visible').click()
     //cy.get('.md-raised > .ng-binding').click()
     cy.wait(35000)
     cy.get('[style="padding-bottom: 0px;"] > .layout-row.flex > :nth-child(1) > .layout-xs-column > .flex-xl-5 > .md-menu-height > .md-icon-button > .ng-scope').click({multiple: true})
    //click on unit details
