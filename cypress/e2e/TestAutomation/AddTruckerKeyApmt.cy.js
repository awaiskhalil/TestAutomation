...
describe('Add Appointment by Selecting Trucker key', () => {
  let today="";
var tomorrow="";
var t1="";
...
//Select Terminal
     ...
     cy.contains('SSAT- Pacific Container Terminal (PCT)').click()
 ...
 // click on next button
     ...
     //select Trucker company
     cy.get('#select_89').click()
    // cy.get('#select_6').click()
     //cy.get('#select_option_25 > .md-text').click({force: true}) 
     cy.contains('Sophilabs trucking , Long Beach').should('be.visible').click() 
    //click on submit button 
    cy.get('#step-content-6 > .ng-scope.ng-isolate-scope > .emPro-border-top > .layout-row > .md-raised > .ng-binding').click()
    ...
    // cy.get('.ng-binding')
     ...
     cy.get('[ng-disabled="showLoader"]').click()
     cy.wait(1000)
     //Verify the Trucker company 
     cy.get(':nth-child(6) > .layout-row > :nth-child(2) > .pro-lbl-text-16').contains('SOTC')
